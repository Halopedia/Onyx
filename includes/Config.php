...
class Config {
	...
	private const DEFAULT_CONFIG = [
		...
		'header-logo' => null,
		'use-sys-message-for-header-tagline' => false,
		'header-tagline-sys-message-source' => 'tagline',
	...
	private const CONFIG_TYPES = [
		...
		'header-logo' => 'string',
		'use-sys-message-for-header-tagline' => 'boolean',
		'header-tagline-sys-message-source' => 'string',
